...
\begin{itemize}
  \item My Role: Constructed storage crash recovery mechanism by achieving \textbf{data duplication in cloud} in \textbf{ESP32S3} microcontroller.
    \item Used \textbf{ESP-IDF framework}, \textbf{FatFS} module for storage management like formatting and partioning.
    \item Wrote \textbf{HTTP Client} with ESP-IDF for backing up files in remote servers.
