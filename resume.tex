...
\begin{itemize}
  \item My Role: Built \textbf{storage crash recovery mechanism} by achieving data duplication in cloud. Used \textbf{ESP-IDF framework}, \textbf{FatFS} module and \textbf{ESP32WebServer} to program in \textbf{ESP32S3 microcontroller} and generate HTTP request.
