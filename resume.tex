...
\begin{itemize}
  \item Worked with two other students and used \textbf{Git} for code collaboration.
  ...
  \item Tried by more than 20 students and received 90\% good comments on user experience.
\end{itemize}

\datedsubsection{\textbf{Multithreaded Traffic Throttling Web Server}}{Sep 2022 -- Nov 2022}
\role{C++}{Individual Projects}
  A simple web server that can read and parse \textbf{http requests} and send corresponding http response header and body for GET method.
\begin{itemize}
