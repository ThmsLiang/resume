...
\role{HTML/CSS, Javascript, PHP, MySQL, AJAX}{Individual Fullstack Web Project}
  A website that users can create watchlists and add movies by searching though OMDB api.
\begin{itemize}
