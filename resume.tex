...
\begin{itemize}
  ...
  \item Coded in Java and XML in \textbf{Android Studio} and used \textbf{Firebase} with its NoSQL database and sign-in authentication. 
  \item Wrote JUnit test and used \textbf{UIAutomator} for blackbox testing in Google Map API.
