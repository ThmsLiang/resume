...
\role{Software Developer Intern | DynamoDB, Express.js, React, AWS EC2}{}
  Help construct an online website for a artist start-up as Capstone Project.
...
\datedsubsection{\textbf{Transactional Relational Database}}{\emph{Java, FoundationDB}}
  A MySQL-like relational database based on \textbf{FoundationDB}, a NoSQL database.
\begin{itemize}
  \item Allow creating/editing/dropping tables with multiple primary keys.
    \item Implemented Hash Indexing and B-tree Indexing.
  \item Support Relation Algebras like group/join using AsyncIterator API.
  \item Leverage \textbf{Transaction} API to follow ACID property.
\end{itemize}
