...
\begin{itemize}
  \item Use \textbf{MySQLi} in PHP for CRUD and \textbf{AJAX} for parsing API in Frontend with BootStrap for layout.
  \item Deployed with\textbf{Relational Database Service (RDS)} and \textbf{Apache} server in AWS \textbf{Elastic Compute Cloud (EC2)}.
\end{itemize}
