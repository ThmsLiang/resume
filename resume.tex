...
\datedsubsection{\textbf{USC Info Lab}, Los Angeles, CA}{Jan 2025 - present}
\role{Master Student Research Assistant | Machine Learning, Causality Analysis, Spatial Analysis}{}
  Topic: Perform causality analysis to pinpoint influential roads triggering network-wide slowdowns.
...
\role{Software Developer Intern (Capstone Project) | Next.js, Firebase}{}
  Spearheaded construction of an artist social networking website for an alumni start-up as Capstone Project.
  \begin{itemize}
  \item Led frontend development and stakeholder communication as team manager:
  \begin{itemize}
    \item Architected responsive UI components with \textbf{Next.js}, delivering pixel-perfect implementation of \textbf{Figma} designs with \textbf{Tailwind CSS}
    \item Orchestrated CI/CD workflow through \textbf{Vercel} for automated testing and deployment
    \item Engineered secure user authentication and real-time data synchronization using \textbf{Firebase}
  \end{itemize}
  \end{itemize}
