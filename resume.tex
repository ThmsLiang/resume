...
\begin{itemize}
  \item My Role: Helped build a new after-sale service website for both consumers and stores.
  \begin{itemize}
    \item Build website with \textbf{Express.js} framework and used \textbf{Mongoose} library to produce REST API for CRUD.
    \item Stored and queried GeoJSON data in \textbf{MongoDB} for users to find nearest stores.
    \item Applied \textbf{Socket.IO} to project to enhance real-time communications between users and stores.
  \end{itemize}
