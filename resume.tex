...
\begin{itemize}
  \item Built \textbf{RESTful API} in PHP for CRUD and used \textbf{AJAX} for parsing API in Frontend.
...
\role{C++11, Web Server} {}
  A simple \textbf{web server} that can read HTTP requests and send responses and desired files through socket.
\begin{itemize}
