...
\begin{itemize}
  \item Used \textbf{MySQLi} in PHP for CRUD and \textbf{AJAX} for parsing API in Frontend with BootStrap for layout.
  \item Deployed with AWS using  \textbf{RDS} and buildling \textbf{Apache} server in AWS \textbf{EC2}.
\end{itemize}
