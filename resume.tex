...
\begin{itemize}
  \item My Role: Helped Constructed storage crash recovery mechanism by implementing data duplication in cloud.
  \begin{itemize}
    \item Used \textbf{ESP-IDF framework}, \textbf{FatFS} module for storage management like formatting and partitioning.
    \item Achieved file transferring with remote server with \textbf{ftplib library} for data duplication.
  \end{itemize}
