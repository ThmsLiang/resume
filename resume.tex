...
\begin{itemize}
  \item My Role: Constructed storage crash recovery mechanism by achieving \textbf{data duplication in cloud}. Used \textbf{ESP-IDF framework}, \textbf{FatFS} module to program in \textbf{ESP32S3} microcontroller and build \textbf{FTP client} for uploading/downloading files.
