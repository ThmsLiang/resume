...
\role{Go, HTTP, Protobuf} {}
  A LRU \textbf{HTTP-based distributed cache system} written by Golang.
\begin{itemize}
  \item Implemented consistent hashing for keeping load balance and increasing cache flexibility.
