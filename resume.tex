...
\begin{itemize}
  \item My Role: Built \textbf{storage crash recovery mechanism} by achieving data duplication in cloud. Used \textbf{ESP-IDF framework}, \textbf{FatFS} module and \textbf{ESP32WebServer} library to program in \textbf{ESP32S3 microcontroller} and generate HTTP request for uploading/downloading files.
...
\begin{itemize}
  ...
  \item My Role: Wrote Java and XML in \textbf{Android Studio} for frontend design and used \textbf{Firebase} for backend with its NoSQL database and sign-in authentication. Used \textbf{UIAutomator} for blackbox testing in Google Map API.
