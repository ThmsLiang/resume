...
\begin{itemize}
  \item My Role: Built \textbf{storage crash recovery mechanism} by formatting, partitioning sd cards and data duplication in cloud. Used \textbf{ESP-IDF framework} and \textbf{FatFS} module to program in \textbf{ESP32S3 microcontroller}.
...
\begin{itemize}
  ...
  \item My Role: Wrote Java and XML in \textbf{Android Studio} for frontend design and used \textbf{Firebase} as backend. Used \textbf{Espresso} and \textbf{UIAutomator} for blackbox testing in Android UI and Google Map API.
...
\begin{itemize}
  ...
  \item Optimized communications between peers and improved system flexibility by sending \textbf{Protobuf} data.
\end{itemize}
...
\role{C++11, Socket Programming} {}
  A simple \textbf{web server} that can read and parse \textbf{http requests} and send corresponding http response.
\begin{itemize}
