...
\role{Software Developer Intern (Capstone Project) | Next.js, FastAPI, Heroku, Firebase}{}
  ...
  \begin{itemize}
    \item Constructed the frontend UI with \textbf{Next.js} and used \textbf{Vercel} to ship.
    \item Developed backend application with \textbf{Python FastAPI} for quick deployment.
    \item Leveraged \textbf{Firebase} for authentication and databse.
