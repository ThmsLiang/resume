...
\role{Software Developer Intern (Capstone Project) | Next.js, FastAPI, Heroku, Firebase}{}
  Help construct an online artwork exploration website for an alumni start-up as Capstone Project.
  \begin{itemize}
  \item My Role: Developed both the frontend and backend and communicated with the stakeholder.
  \begin{itemize}
    \item Constructed the frontend UI with \textbf{Next.js} (a React.js framework), combined with \textbf{NextUI} for unique stylish design, and used \textbf{Vercel} to publish.
    \item Leveraged \textbf{Firebase} for authentication, realtime database and media storage. Integrated \textbf{Heroku} for backend deployment and CI/CD pipeline.
  \end{itemize}
  \end{itemize}
