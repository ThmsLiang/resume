...
\begin{itemize}
  ...
  \item My Role: Wrote Java and XML in \textbf{Android Studio} for frontend design and used \textbf{Firebase} as backend. Used \textbf{UIAutomator} for blackbox testing in Google Map API.
