...
\begin{itemize}
  ...
  \item My Role: Implemented main-page activity and database interface for backend.
  \begin{itemize}
...
\begin{itemize}
  ...
  \item Followed \textbf{Lock Hierachy} technique by setting two-level locks to avoid deadlock issues.
\end{itemize}
