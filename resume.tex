...
\role{Software Developer Intern (Capstone Project) | Next.js, FastAPI, Heroku, Firebase}{}
  ...
  \begin{itemize}
    \item Constructed the frontend UI with \textbf{Next.js} (a React.js framework), combined with \textbf{NextUI} for unique stylish design, and used \textbf{Vercel} for CI/CD pipeline. Exploited /textbf{Tailwind CSS} for responsive design.
