...
\begin{itemize}
  \item My Role: Constructed storage crash recovery mechanism by achieving data duplication in cloud. Used \textbf{ESP-IDF framework}, \textbf{FatFS} module to program in \textbf{ESP32S3} microcontroller and build \textbf{FTP client} for uploading/downloading files.
...
\role{HTML/CSS, Javascript, PHP, MySQL, AJAX, BootStrap, AWS} {}
  Developed a multi-page website allowing users to create watchlists and search movies through OMDB API.
\begin{itemize}
  \item Produced \textbf{RESTful API} with PHP for CRUD and used \textbf{AJAX} for parsing API in Frontend.
