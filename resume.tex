...
\role{Software Developer Intern (Capstone Project) | Next.js, FastAPI, Heroku, Firebase}{}
  ...
  \begin{itemize}
    \item Constructed the frontend UI with \textbf{Next.js} (a React.js framework), designed with \textbf{Figma} for unique style, and used \textbf{Vercel} for CI/CD pipeline.
    \item Exploited /textbf{Tailwind CSS} for responsive design.
