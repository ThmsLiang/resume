...
\begin{itemize}
  \item Established \textbf{storage crash recovery mechanism} by formatting, partitioning sd cards and achieving data duplication in cloud.
...
\begin{itemize}
  ...
  \item Normalized data to improve database flexibility and avoid data reduncy.
\end{itemize}
