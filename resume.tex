...
\role{Go, HTTP, Protobuf} {}
  A LRU \textbf{distributive cache system} written by Golang.
\begin{itemize}
  \item Supported both local cache and http-base ditributive cache.
  \item Allowed concurrent read/write from multiple \textbf{goroutine} with Go's Mutex.
  \item Optimize binary data communication between two nodes with \textbf{Protobuf}.
\end{itemize}
