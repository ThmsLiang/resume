...
\begin{itemize}
  ...
  \item My Role: Implemented main-page activity and database interface to backend.
  \begin{itemize}
    \item Coded in Java in \textbf{Android Studio} and used \textbf{Firebase} for NoSQL database and sign-in authentication. 
    \item Wrote \textbf{JUnit} tests for whitebox testing and used \textbf{UIAutomator} for blackbox testing in Google Map API.
  \end{itemize}
