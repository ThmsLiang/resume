...
\role{Software Developer Intern (Capstone Project) | Next.js, FastAPI, Heroku, Firebase}{}
  Help construct an online website for an alumni start-up as Capstone Project.
  \begin{itemize}
  \item My Role: Developed both the frontend and backend and communicated with the stakeholder.
  \begin{itemize}
    \item Constructed the frontend UI with \textbf{Next.js}, combined with \textbf{NextUI} for unique design, and used \textbf{Vercel} to ship.
    \item Developed backend application with \textbf{Python FastAPI} for quick deployment, and Leveraged \textbf{Firebase} for authentication and databse.
    \item Integrated \textbf{Heroku} for backend deployment and CI/CD pipeline.
  \end{itemize}
  \end{itemize}
