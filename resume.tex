...
\begin{itemize}
  \item My Role: Built storage crash recovery mechanism by achieving data duplication in cloud. Used \textbf{ESP-IDF framework}, \textbf{FatFS} module and \textbf{ESP32WebServer} library to program in \textbf{ESP32S3} microcontroller and generate \textbf{HTTP} request for uploading/downloading files.
  \item Influenced products sell by millions and potentionally saved thoudsands of dollars from outsourced repairing.
\end{itemize}
